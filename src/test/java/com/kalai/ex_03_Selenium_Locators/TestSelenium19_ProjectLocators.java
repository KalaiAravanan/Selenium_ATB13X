...
public class TestSelenium19_ProjectLocators {
    @Test
...
//        driver.manage().window().maximize();
        ...
        WebElement notifymsg = driver.findElement(By.className("notification-box-description"));
        String msg = notifymsg.getText();
